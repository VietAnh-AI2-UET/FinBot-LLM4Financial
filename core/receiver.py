...
def get_database(input_model='all-MiniLM-L6-v2') -> tuple:
...
def get_user_question_embedding(input_model='all-MiniLM-L6-v2') -> tuple:
...
def find_information(input_model='all-MiniLM-L6-v2', k=5) -> tuple:
    user_question, user_question_vector = get_user_question_embedding(input_model=input_model)
    index, metadatas = get_database(input_model='all-MiniLM-L6-v2')
